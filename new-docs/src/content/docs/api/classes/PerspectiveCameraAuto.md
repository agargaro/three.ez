...
> **new PerspectiveCameraAuto**(`fov`?, `near`?, `far`?): [`PerspectiveCameraAuto`](/api/classes/perspectivecameraauto/)
...
• **listener**: `EventListener`\<`Object3DEventMap`\[`T`\], `T`, [`PerspectiveCameraAuto`](/api/classes/perspectivecameraauto/)\>
...
• **T** *extends* keyof [`PerspectiveCameraAuto`](/api/classes/perspectivecameraauto/)
...
:::caution[Deprecated]
Use [.setFocalLength()](/api/classes/perspectivecameraauto/#setfocallength) and [.filmGauge](/api/classes/perspectivecameraauto/#filmgauge) instead.
:::
