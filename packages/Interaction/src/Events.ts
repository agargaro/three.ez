import { Camera, Intersection, Matrix4, Object3D, Quaternion, Vector3, WebGLRenderer } from "three";
 ...
 */
export interface InteractionEvents<T = Object3D, R = Object3D, RD = Object3DLike> {
 ...
 * @template T - The type of the primary target for the event (default is `Object3D`).
 * @template R - The type of the related target for the event (default is `Object3DLike`).
 */
export class DragEventExt<T = Object3D, R = Object3DLike> extends PointerEventExt<T, R> {
