...
export class Main {
   ...
   */
  public get activeView(): RenderView {
  ...
  public get activeScene(): Scene {
    return this._renderManager.activeView?.scene;
  }
  ...
  public get activeCamera(): Camera {
    return this._renderManager.activeView?.camera;
  }

  /**
   * The EffectComposer (used for post-processing) associated with the currently active RenderView.
   */
  public get activeComposer(): EffectComposer {
    return this._renderManager.activeView?.composer;
  }
  ...
  public set multitouch(value: boolean) {
    this._interactionManager.queue.multitouch = value;
  }
   ...
   */
  public get dragButtons(): number[] {
    return this._interactionManager.dragManager.dragButtons;
  }
  public set dragButtons(value: number[]) {
    this._interactionManager.dragManager.dragButtons = value;
  }
  ...
  public set enableCursor(value: boolean) {
    this._interactionManager.cursorManager.enabled = value;
  }

  /**
   * A custom sorting comparer function used to order intersections when performing raycasting.
   */
  public get raycasterSortComparer(): RaycasterSortComparer {
    return this._interactionManager.raycasterManager.raycasterSortComparer;
  }
  public set raycasterSortComparer(value: RaycasterSortComparer) {
    this._interactionManager.raycasterManager.raycasterSortComparer = value;
  }
  ...
  public set backgroundColor(value: ColorRepresentation) {
    this._renderManager.backgroundColor = value;
  }
  ...
  public set backgroundAlpha(value: number) {
    this._renderManager.backgroundAlpha = value;
  }
   ...
   */
  public get pointerOnCanvas(): boolean {
