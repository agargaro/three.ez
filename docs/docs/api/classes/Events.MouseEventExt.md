...
• **new MouseEventExt**\<`T`, `R`\>(`event`, `intersection`, `relatedTarget?`, `cancelable?`): [`MouseEventExt`](Events.MouseEventExt.md)\<`T`, `R`\>
...
[src/events/Events.ts:163](https://github.com/agargaro/three.ez/blob/c98e2000aba94763fdfaf44f220a0d54ccd99dd1/src/events/Events.ts#L163)
