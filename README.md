...
<script type="importmap">
{
  "imports": {
    ...
    "@three.ez/main": "https://unpkg.com/@three.ez/main@0.4.10/bundle.js"
  }
}
</script>
```
...
- [InstancedMesh2](https://stackblitz.com/edit/three-ez-instancedmeshentity?file=src%2Fmain.ts)
— [InstancedMesh2 Performance](https://stackblitz.com/edit/three-ez-instancedmeshentity-performance?file=src%2Fmain.ts)
